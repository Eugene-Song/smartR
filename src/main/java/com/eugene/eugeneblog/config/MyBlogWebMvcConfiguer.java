package com.eugene.eugeneblog.config;




import com.eugene.eugeneblog.interceptor.AdminLoginInterceptor;
...
@Configuration
class MyBlogWebMvcConfigurer implements WebMvcConfigurer {
