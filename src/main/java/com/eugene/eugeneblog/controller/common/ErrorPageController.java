package com.eugene.eugeneblog.controller.common;
...
public class ErrorPageController implements ErrorController {
    ...
    protected Map<String, Object> getErrorAttributes(HttpServletRequest request, Object includeStackTrace) {
        WebRequest webRequest = new ServletWebRequest(request);
        return this.errorAttributes.getErrorAttributes(webRequest, (ErrorAttributeOptions) includeStackTrace);
    }
